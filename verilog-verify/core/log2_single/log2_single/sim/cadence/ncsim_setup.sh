...
# ACDS 16.1 196 win32 2018.07.02.17:18:26
...
# ----------------------------------------
# If log2_single is one of several IP cores in your
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/../altera_fp_functions_161/sim/log2_single_altera_fp_functions_161_kypxfny_memoryC0_uid92_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/../altera_fp_functions_161/sim/log2_single_altera_fp_functions_161_kypxfny_memoryC1_uid95_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/../altera_fp_functions_161/sim/log2_single_altera_fp_functions_161_kypxfny_memoryC2_uid98_lnTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library_package.vhd"                       -work log2_single_altera_fp_functions_161 -cdslib ./cds_libs/log2_single_altera_fp_functions_161.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library.vhd"                               -work log2_single_altera_fp_functions_161 -cdslib ./cds_libs/log2_single_altera_fp_functions_161.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/log2_single_altera_fp_functions_161_kypxfny.vhd" -work log2_single_altera_fp_functions_161 -cdslib ./cds_libs/log2_single_altera_fp_functions_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/log2_single.v"                                                                                                                                                                          
fi
