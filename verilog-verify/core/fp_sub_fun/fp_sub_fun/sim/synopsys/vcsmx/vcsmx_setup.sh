...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library_package.vhd"                      -work fp_sub_fun_altera_fp_functions_161
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library.vhd"                              -work fp_sub_fun_altera_fp_functions_161
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/fp_sub_fun_altera_fp_functions_161_fshcoka.vhd" -work fp_sub_fun_altera_fp_functions_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/fp_sub_fun.v"                                                                                                          
fi
