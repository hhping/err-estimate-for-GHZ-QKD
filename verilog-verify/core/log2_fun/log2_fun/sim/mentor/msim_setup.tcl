...
# ----------------------------------------
# If log2_fun is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2018.07.02.14:05:42
...
ensure_lib                                  ./libraries/log2_fun_altera_fp_functions_161/
vmap       log2_fun_altera_fp_functions_161 ./libraries/log2_fun_altera_fp_functions_161/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library_package.vhd"                    -work log2_fun_altera_fp_functions_161
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library.vhd"                            -work log2_fun_altera_fp_functions_161
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/log2_fun_altera_fp_functions_161_f7x7wfy.vhd" -work log2_fun_altera_fp_functions_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/log2_fun.v"                                                                                                        
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L log2_fun_altera_fp_functions_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
