...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library_package.vhd"                    -work log2_fun_altera_fp_functions_161
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library.vhd"                            -work log2_fun_altera_fp_functions_161
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/log2_fun_altera_fp_functions_161_f7x7wfy.vhd" -work log2_fun_altera_fp_functions_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/log2_fun.v"                                                                                                        
fi
