...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k "$QSYS_SIMDIR/../altera_fp_functions_141/sim/log2_fun_altera_fp_functions_141_dehmhdi.vo" -work log2_fun_altera_fp_functions_141
  vlogan +v2k "$QSYS_SIMDIR/log2_fun.v"                                                                                                       
fi
