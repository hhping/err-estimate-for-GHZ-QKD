...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/quartus14.1_install/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/log2_fun_altera_fp_functions_141/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog           "$QSYS_SIMDIR/../altera_fp_functions_141/sim/log2_fun_altera_fp_functions_141_dehmhdi.vo" -work log2_fun_altera_fp_functions_141 -cdslib ./cds_libs/log2_fun_altera_fp_functions_141.cds.lib
  ncvlog -compcnfg "$QSYS_SIMDIR/log2_fun.v"                                                                                                                                                                   
fi
